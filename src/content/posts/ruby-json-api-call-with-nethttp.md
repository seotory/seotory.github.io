...
1. [http://curl.haxx.se/ca/cacert.pem](http://curl.haxx.se/ca/cacert.pem) 파일을 `C:\RailsInstaller\` 폴더에 넣는다.
...
- [net/http solution](https://gist.github.com/fnichol/867550)
- [net/http source code](http://rxr.whitequark.org/mri/source/lib/net/http.rb)
- [Ruby OpenSSL](https://blog.udemy.com/ruby-openssl/)
